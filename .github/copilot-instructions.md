# Instruções para o GitHub Copilot: Mensagens de Commit

Sempre gere mensagens de commit em inglês seguindo o padrão **Conventional Commits**. Use o formato:
<type>[optional scope]: <description>

Examples:
feat: add login functionality
fix: fix bug in email validation
